...
class Node{
	...
	**/
	...
	/**
		IT RETURN and alaki node
		to use if list.getAsArray
		beacuse of erasure, we need T.getClss...
	**/
	...
	**/
	...
	/**
		search all list of nodes and delte the empty ones
		note that deleting is O(n)
		but we know that at most, we hace one or two nodes to delete
